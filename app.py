...
(function () {{
  ...
  swiperScript.onload = function () {{
    ...
    new window.Swiper(continueEl, {{
      ...
      coverflowEffect: {{ rotate: 18, stretch: 0, depth: 180, modifier: 1.2, slideShadows: false, scale: 0.92 }},
      ...
      breakpoints: {{
        ...
        768: {{ coverflowEffect: {{ rotate: 18, stretch: 0, depth: 180, modifier: 1.2, slideShadows: false, scale: 0.92 }} }},
      }},
    }});
  }};
