...
def student_subject_module_page(subject_id: int, module_id: int):
    ...
    .hero-title h2{{margin:6px 0 4px;font-size:clamp(1.3rem,2vw,1.75rem);line-height:1.1;font-weight:600;color:#0f172a}}
    .hero-title p{{margin:0 0 4px;color:#1e293b;font-size:clamp(1.3rem,2vw,1.75rem);font-weight:600;line-height:1.1}}
