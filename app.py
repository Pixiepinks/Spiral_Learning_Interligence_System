...
(function () {{
  ...
  swiperScript.onload = function () {{
    ...
    new window.Swiper(continueEl, {{
      ...
      coverflowEffect: {{ rotate: 14, stretch: 0, depth: 130, modifier: 1.0, slideShadows: false, scale: 0.92 }},
      autoplay: {{ delay: 3500, disableOnInteraction: false }},
      navigation: {{ nextEl: "#continueNext", prevEl: "#continuePrev" }},
      pagination: {{ el: "#continuePagination", clickable: true }},
      breakpoints: {{
        0: {{ coverflowEffect: {{ rotate: 10, stretch: 0, depth: 90, modifier: 1, slideShadows: false, scale: 0.9 }} }},
        768: {{ coverflowEffect: {{ rotate: 14, stretch: 0, depth: 130, modifier: 1.0, slideShadows: false, scale: 0.92 }} }},
      }},
    }});
  }};
