...
@media (max-width: 899px) {{
  ...
  .continue-module-grid,
  .continue-modules-grid,
  ...
  .continue-module-subject {{
    font-size: 12px !important;
    line-height: 1.25 !important;
    margin: 0 0 10px !important;
  }}

  .continue-module-progress-row {{
    display: flex !important;
  ...
  .continue-module-play {{
    width: 38px !important;
    height: 38px !important;
    border-radius: 14px !important;
  }}

  .continue-module-progress-bar {{
...
@media (max-width: 899px) {{
  ...
  .dashboard-main-grid .dashboard-left-column,
  .dashboard-main-grid .dashboard-right-column,
  .dashboard-main-grid .student-insights-row {{
  ...
  .dashboard-main-grid .dashboard-left-column > .grid {{
    order: 0 !important;
  }}

  .dashboard-main-grid .dashboard-left-column > .continue-learning-section {{
    order: 5 !important;
  }}
...
@media (max-width:899px){{.app{{display:block !important;min-height:100vh}}.side{{position:fixed !important;inset:0 auto 0 0;width:min(86vw, 320px) !important;max-width:320px !important;transform:translateX(-105%);transition:transform .25s ease;z-index:9999;overflow-y:auto;border-radius:0 28px 28px 0;box-shadow:24px 0 60px rgba(0,0,0,.28)}}body.mobile-menu-open .side{{transform:translateX(0)}}.mobile-menu-backdrop{{display:none;position:fixed;inset:0;background:rgba(2,8,23,.55);backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);z-index:9998}}body.mobile-menu-open .mobile-menu-backdrop{{display:block}}.main{{padding-right:14px !important;padding-bottom:86px !important;padding-left:14px !important;width:100% !important;box-sizing:border-box}}.mobile-dashboard-header{{display:flex !important}}.mobile-bottom-nav{{display:grid !important}}.mobile-drawer-close{{display:grid;position:absolute;top:12px;right:12px;width:34px;height:34px;border:0;border-radius:12px;background:rgba(255,255,255,.16);color:white;font-size:24px;place-items:center;cursor:pointer}}.mobile-bottom-nav{{position:fixed;left:12px;right:12px;bottom:12px;grid-template-columns:repeat(5, 1fr);gap:4px;z-index:9997;padding:8px;border-radius:22px;background:rgba(255,255,255,.86);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:0 18px 44px rgba(15,23,42,.18)}}.mobile-bottom-nav a{{min-height:52px;border-radius:16px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;color:#64748b;font-size:17px;text-decoration:none;font-weight:800}}.mobile-bottom-nav a span{{font-size:10px}}.mobile-bottom-nav a.active{{background:linear-gradient(135deg,#1e66f5,#7c3aed);color:white}}}}</style>
    </head><body><div class="mobile-dashboard-header"><button type="button" class="mobile-menu-toggle" onclick="document.body.classList.add('mobile-menu-open')" aria-label="Open student menu">☰</button><div class="mobile-brand"><img src="/static/images/SLIS LOGO.png" alt="SLIS"><div><strong>{escape(student.name)}</strong><span>Student Dashboard</span></div></div><a class="mobile-profile-pill" href="/student/profile" aria-label="Student profile">👤</a></div><div class="mobile-quick-actions">
  <a href="/student/notifications" class="mobile-action-btn">🔔<span>Alerts</span></a>
  <a href="/student/messages" class="mobile-action-btn">💬<span>Messages</span></a>
  <a href="/student/quizzes" class="mobile-action-btn">❓<span>Quizzes</span></a>
  <a href="/student/search" class="mobile-action-btn">🔍<span>Search</span></a>
</div><div class="mobile-menu-backdrop" onclick="document.body.classList.remove('mobile-menu-open')"></div><div class='app'><aside class='side'><button type="button" class="mobile-drawer-close" onclick="document.body.classList.remove('mobile-menu-open')" aria-label="Close student menu">×</button><div class='sidebar-brand'><img src='/static/images/SLIS LOGO.png' alt='SLIS logo'><div class='sidebar-brand-title'>Spiral Learning Intelligence System</div></div>
