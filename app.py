...
def render_student_dashboard_shell(inner_html, active_nav="dashboard"):
    ...
    nav_links = [
        ("dashboard", "/student-dashboard", "<svg viewBox='0 0 24 24'><path d='M3 11.5 12 4l9 7.5'></path><path d='M5 10.5V20h14v-9.5'></path></svg>", "ඩෑෂ්බෝඩ්"),
        ("my_subjects", "/student/learning-path", "<svg viewBox='0 0 24 24'><path d='M4.5 6.5h6.8v12.5H4.5z'></path><path d='M12.7 6.5H19.5V19H12.7z'></path><path d='M8 9.5h.01'></path><path d='M16 9.5h.01'></path></svg>", "මගේ විෂයයන්"),
        ("live_classes", "/student/live-classes", "<svg viewBox='0 0 24 24'><path d='M6 5h12a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-5l-3.5 3v-3H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z'></path></svg>", "සජීවී පන්ති"),
    ]
    nav_html = "".join(
        f"<a class='nav-link{' active' if key==active_nav else ''}' href='{href}'><span class='nav-icon'>{icon}</span><span>{label}</span></a>"
        for key, href, icon, label in nav_links
    )
