...
def student_dashboard():
    ...
    <script>(function () {{
  function initStudentPhotoModal() {{
    ...
    console.log("SLIS photo modal check:", {{
      changeBtn: !!changeBtn,
      modal: !!modal,
      closeBtn: !!closeBtn
    }});
    ...
    if (!changeBtn || !modal) {{
      console.warn("SLIS photo modal elements missing.");
      return;
    }}
  ...
  if (document.readyState === "loading") {{
    document.addEventListener("DOMContentLoaded", initStudentPhotoModal);
  }} else {{
    initStudentPhotoModal();
  }}
