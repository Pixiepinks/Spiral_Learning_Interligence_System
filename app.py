...
def student_dashboard():
    ...
    for index, (module, _, subject) in enumerate(modules):
        ...
        continue_cards.append(
            f"<article class='continue-module-card'><img src='{escape(module_image)}' alt='{escape(module_name)}' class='continue-module-cover' loading='lazy'><div class='continue-module-body'><h4 class='continue-module-title'>{escape(module_name)}</h4><p class='continue-module-subject'>{escape(subject_name)}</p><div class='continue-module-progress'><span>{progress_value}%</span><button type='button' class='continue-module-play' aria-label='{escape(continue_label)}'>▶</button></div><div class='continue-module-progress-bar'><span class='continue-module-progress-fill' style='width:{progress_value}%;'></span></div></div></article>"
        )
